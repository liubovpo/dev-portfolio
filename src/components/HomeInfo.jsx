...
const renderContent = {
  ...
  2: (
    <InfoBox
      text="Transitioned from a web design background to pursue my passion for development"
      link="/about"
      btnText="Learn more"
    />
  ),
  3: (
    <InfoBox
      text="Check out my portfolio showcasing a variety of exciting full-stack projects!"
      link="/projects"
      btnText="Portfolio"
    />
  ),
